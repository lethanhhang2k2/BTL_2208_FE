...
export default function UploadAvatar({ default_value }) {
    const [avt, setAvt] = useState(default_value || default_avatar)
    ...
    return (
        <label
            ...
            <div className="h-full">
                <img src={avt} className="h-[152px] w-auto object-cover rounded-full" alt="user-avatar" />
            </div>
            <input
                type="file"
